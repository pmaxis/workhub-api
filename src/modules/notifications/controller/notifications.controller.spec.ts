...
describe('NotificationsController', () => {
  ...
  it('findAll delegates to service', async () => {
    ...
    const res = await controller.findAll({ page: 1, limit: 20 }, 'u1', {} as any);
